<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoldenHourTicket.aspx.cs" Inherits="CasinoKiosk.Assets.Reports.GoldenHourTicket" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function doPrint() {
             var prtContent = document.getElementById('<%= ReportViewerGoldenHour.ClientID %>');
...
<body style="text-align: center">
    ...
    <form id="form1" runat="server" style="display:inline-block">
        ...
        <div>
            <rsweb:ReportViewer ID="ReportViewerGoldenHour" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1200px" Height="1200px" BorderStyle="Solid" BorderWidth="1px" SizeToReportContent="True" ShowPrintButton="True" Font-Bold="True">
            </rsweb:ReportViewer>
        </div>
    </form>
</body>
