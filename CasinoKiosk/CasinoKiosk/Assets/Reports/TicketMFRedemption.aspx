<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TicketMFRedemption.aspx.cs" Inherits="CasinoKiosk.Assets.Reports.TicketMFRedemption" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function doPrint() {
            var prtContent = document.getElementById('<%= ReportViewerMFRedemption.ClientID %>');
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 731px">
            ...
            <rsweb:ReportViewer ID="ReportViewerMFRedemption" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1200px" Height="1200px" SizeToReportContent="True" ShowPrintButton="True">
            </rsweb:ReportViewer>
