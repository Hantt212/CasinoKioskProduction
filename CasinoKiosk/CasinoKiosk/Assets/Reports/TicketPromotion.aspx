<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TicketPromotion.aspx.cs" Inherits="CasinoKiosk.Assets.Reports.TicketPromotion" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function doPrint() {
            var prtContent = document.getElementById('<%=ReportViewerTicketPromotion.ClientID %>');
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 731px">
            ...
            <asp:TextBox ID="txtPID1" runat="server" />
            ...
            <rsweb:ReportViewer ID="ReportViewerTicketPromotion" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1200px" Height="1200px" SizeToReportContent="True" ShowPrintButton="True">
            </rsweb:ReportViewer>     
