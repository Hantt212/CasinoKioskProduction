<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyPSBundleTicket.aspx.cs" Inherits="CasinoKiosk.Assets.Reports.DailyPSBundleTicket" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function doPrint() {
            var prtContent = document.getElementById('<%= ReportViewerDailyPSBundle.ClientID %>');
...
<body>
    ...
    <form id="form1" runat="server">
        <div style="width: 731px">
            ...
            <br />           
            <rsweb:ReportViewer ID="ReportViewerDailyPSBundle" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1200px" Height="1200px" SizeToReportContent="True" ShowPrintButton="True" Font-Bold="True">
            </rsweb:ReportViewer>
        </div>
    </form>
</body>
