<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tickets.aspx.cs" Inherits="CasinoKiosk.Assets.Reports.Tickets" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function doPrint() {
            var prtContent = document.getElementById('<%= ReportViewerRedempTion.ClientID %>');
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 731px">
            ...
            <asp:Label ID="Label1" runat="server" Text="Ticket. No:  " Font-Size="12pt"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtIDRedemption" runat="server" Width="240px" Font-Size="Medium"></asp:TextBox>
            ...
            <rsweb:ReportViewer ID="ReportViewerRedempTion" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1200px" Height="1200px" SizeToReportContent="True" ShowPrintButton="True">
            </rsweb:ReportViewer>
